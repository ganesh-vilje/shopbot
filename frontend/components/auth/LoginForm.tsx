      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors" style={{borderColor:"#C0392B"}}>

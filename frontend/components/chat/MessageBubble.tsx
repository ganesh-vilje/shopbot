        ...
        {isUser ? (
          ...
          <>
            <div className="flex items-center gap-1.5 h-5">
              <span className="message-loading-dot" style={{ animationDelay: "0s" }} />
              <span className="message-loading-dot" style={{ animationDelay: "0.18s" }} />
              <span className="message-loading-dot" style={{ animationDelay: "0.36s" }} />
            </div>
            <style jsx>{`
              .message-loading-dot {
                width: 8px;
